// 1) message icon 
// 2) Cap icon
// 3) Request Icon located at All Shop page Header
// 4) icon name '_0053_Forma-1.png'  green icon remain
// 5) icon name '_0050_Vector-Smart-Object-copy.png' grey icon remain
// 6) Cover button as like as swipe button
// 7) Attache pin icon
const fonts = {
